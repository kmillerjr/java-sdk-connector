...
public class QueryProcessorMessageProcessorDebuggable
    extends QueryProcessorMessageProcessor
    implements DebugInfoProvider
{


    public QueryProcessorMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
