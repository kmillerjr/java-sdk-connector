...
/**
 * GreetMessageProcessor invokes the {@link com.kmiller.mule.modules.javasdk.JavaSDKConnector#greet(java.lang.String)} method in {@link JavaSDKConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        throws Exception
    {
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                {
                    try {
                        return ((JavaSDKConnector) object).greet(_transformedFriend);
                    } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at JavaSDKConnector at greet retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
